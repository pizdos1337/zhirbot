...
BASE_MINUS_CHANCE = 0.1  # Базовый шанс на минус (10%)
MAX_MINUS_CHANCE = 0.5   # Максимальный шанс на минус (50%)
PITY_INCREMENT = 0.05    # На сколько увеличивается шанс за каждый плюс подряд (5%)

# Настройки накопления на плюс от минусов
CONSECUTIVE_MINUS_BOOST = 0.1  # Каждый минус подряд даёт +10% к шансу на плюс
MAX_CONSECUTIVE_MINUS_BOOST = 0.5  # Максимальный бонус 50%

# Настройки джекпота (скрыты от пользователей)
BASE_JACKPOT_CHANCE = 0.01  # Базовый шанс на джекпот (1%)
...
JACKPOT_MAX = 1000  # Максимальный джекпот

# Настройки кейса
CASE_COOLDOWN_HOURS = 12  # Кулдаун на !жиркейс (12 часов)
